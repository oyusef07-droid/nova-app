...
export const meta = () => {
    return [
        { title: "NOVA - Universal Media Downloader | تحميل الفيديوهات والصور مجاناً" },
        { name: "description", content: "أداة NOVA لتحميل الفيديوهات، الريلز، والصور من إنستجرام، يوتيوب، فيسبوك، وتيك توك مجاناً وبدون علامة مائية. Download videos and images from 1000+ platforms." },
        { name: "keywords", content: "تحميل تيك توك بدون علامة, تنزيل ريلز انستجرام, تحميل من اليوتيوب, تحميل ستوري, سناب شات, tiktok downloader, instagram reels download, youtube video downloader, nova downloader" },
        { name: "google-site-verification", content: "df2VmIn8I84Noq6UYOBgL9Jz979MJOxXt1mo-QzoCVU" },
        { property: "og:title", content: "NOVA - Universal Media Downloader" },
        { property: "og:description", content: "أداة NOVA لتحميل الفيديوهات، الريلز، والصور مجاناً. Download videos and images from 1000+ platforms." },
    ];
};
export const links = () => [];
...
function InternalErrorBoundary({ error: errorArg }) {
    ...
    const { buttonProps: copyButtonProps } = useButton({
        onPress: useCallback(() => {
            ...
            toast.custom(() => (<div style={toastStyle}>
    ...
    return (<>
      {!isInIframe() && (<div className={`fixed bottom-4 left-1/2 transform -translate-x-1/2 max-w-md z-50 transition-all duration-500 ease-out ${isOpen ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`} style={{ width: '75vw' }}>
          <div className="bg-[#18191B] text-[#F2F2F2] rounded-lg p-4 shadow-lg w-full" style={scaleFactor !== 1
                ? {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-2 flex-1">
                ...
                <button className={`flex flex-row items-center justify-center gap-[4px] outline-none transition-colors rounded-[8px] border-[1px] bg-[#2C2D2F] hover:bg-[#414243] active:bg-[#555658] border-[#414243] text-white ${copyButtonTextClass} ${copyButtonPaddingClass} w-fit`} type="button" {...copyButtonProps}>
                  Copy error
                </button>
              </div>
            </div>
    ...
    return (<html lang="en">
      <head>
        ...
        {(!pathname || !pathname.startsWith('/admin')) && (<>
            <meta name="monetag" content="112539053c6168a2bb0b99889a91a303"/>
            <script type="text/javascript" src="https://pl29640800.effectivecpmnetwork.com/96/4a/4c/964a4c5b585ad4b552b1fa3df8de0b05.js"></script>
            <script dangerouslySetInnerHTML={{
                __html: `(function(s){s.dataset.zone='11102116',s.src='https://n6wxm.com/vignette.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))`
            }}/>
          </>)}
      </head>
      <body>
