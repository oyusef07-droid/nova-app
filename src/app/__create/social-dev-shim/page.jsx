...
export default function SocialDevShimPage() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center font-sans bg-gray-100 dark:bg-gray-800">
			<div className="bg-white dark:bg-gray-900 rounded-xl p-8 w-full max-w-[400px] shadow-md">
				...
				<form onSubmit={handleSubmit}>
					<label className="block mb-4">
						...
						<input
							...
							className="w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 text-sm"
						/>
					</label>
